    ...
    <>
      ...
      <div className="max-width">
        ...
        <div className="autores-box">
          ...
          <a href="https://github.com/almeidaa1" target="_blank" rel="noreferrer">
            Rui Almeida
          </a>{" "}
          <span>| </span>
          <a href="https://github.com/Rodri-Nascimento" target="_blank" rel="noreferrer">
            Rodrigo Nascimento
          </a>
          <span> | </span>
          <a href="https://github.com/Vampyyr" target="_blank" rel="noreferrer">
            David Leonel
          </a>{" "}
        </div>
      </div>
